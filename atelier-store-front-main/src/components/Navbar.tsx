          ...
          <div className="flex items-center space-x-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-slate-800 border-slate-700">
                {artists.map((artist) => (
                  <DropdownMenuItem key={artist} className="text-white hover:bg-slate-700">
                    {artist}
                  </DropdownMenuItem>
                ))}
                <DropdownMenuItem
                  className="text-purple-300 hover:bg-slate-700 font-medium"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-slate-800 border-slate-700">
                {merchItems.map((item) => (
                  <DropdownMenuItem key={item} className="text-white hover:bg-slate-700">
                    {item}
                  </DropdownMenuItem>
                ))}
                <DropdownMenuItem
            ...
            {/* Cart Icon */}
            <Link to="/cart">
              <Button variant="ghost" size="icon" className="text-white hover:text-purple-300 relative">
